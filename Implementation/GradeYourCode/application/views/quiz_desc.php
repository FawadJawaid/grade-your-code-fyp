<html>
    ...
    <div style="width:50%; margin: 0 auto; background: #71D6C6; padding-right: 10%; padding-left: 10%; padding-top: 3%; padding-bottom: 3%;">
        ...
        <?php
        if (isset($q)) {
            echo " <td class='center'><h2 class='page-header'>Title: </h2> <b><p style='color:#009D64'>" . $quiz->name . " </p></b></td><br />";
            ...
            for ($i = 0; $i < count($q); $i++) {
                ...
                echo " <td class='center'> <a href='" . base_url('index.php/teacher/ViewQuestionDescription/' . $q[$i]->id) . "'>" . $q[$i]->title . "</a> <a class='btn btn-large btn-danger' style='margin-left:10px;float:right;margin-bottom:10px' href='" . base_url('index.php/teacher/DeleteQuizQuestion/' . $q[$i]->id) . "'>DELETE</a></td><br>";
